...
class Localizer:
    ...
    def __init__(self, frame0_index, detector, matcher, left0_img, right0_img, left1_img, right1_img, left0_ex_camera,
    ...
    def plot_match_on_4_images(self, match_idx, title=""):
        ...
        ax[0, 0].imshow(self.left0_img, cmap='gray')
        ax[0, 0].scatter(left0_kp.pt[0], left0_kp.pt[1], c='r', s=3)
        ax[0, 1].imshow(self.right0_img, cmap='gray')
        ax[0, 1].scatter(right0_kp.pt[0], right0_kp.pt[1], c='r', s=3)
        ax[1, 0].imshow(self.left1_img, cmap='gray')
        ax[1, 0].scatter(left1_kp.pt[0], left1_kp.pt[1], c='r', s=3)
        ax[1, 1].imshow(self.right1_img, cmap='gray')
...
def create_track_db(track_db_path):
    ...
    for i in range(ITERATIONS):
        ...
        localizer = Localizer(i, feature_detector, bf, left0, right0, left1, right1, left0_extrinsic,
                              right0_extrinsic, k, track_db,
        ...
        computed_left1_extrinsic, _ = localizer.pnp_ransac()
